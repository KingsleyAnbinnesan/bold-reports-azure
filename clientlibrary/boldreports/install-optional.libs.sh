...
assembly=("phantomjs" "mysql" "oracle" "postgresql" "snowflake" "googlebigquery" "mongodb")
...
do
pluginpath=$root_path/application/reporting/$dirname
yes | cp -rpf $clientlibraryextractpath/BoldReports.Data.GoogleBigQuery.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/Google.Cloud.BigQuery.V2.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/Google.Api.Gax.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/Google.Api.Gax.Rest.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/Google.Apis.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/Google.Apis.Auth.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/Google.Apis.Bigquery.v2.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/Google.Apis.Core.dll $pluginpath
done
...
do
pluginpath=$root_path/application/reporting/$dirname
yes | cp -rpf $clientlibraryextractpath/BoldReports.Data.MongoDB.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/MongoDB.Bson.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/MongoDB.Driver.dll $pluginpath
yes | cp -rpf $clientlibraryextractpath/DnsClient.dll $pluginpath
